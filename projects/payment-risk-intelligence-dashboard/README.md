...
- `assets/images/` – Dashboard screenshots and visual references
- `dashboard/` – Power BI model with all analytical dashboards
- `dataset/` – Transaction and fraud case data
